...
COPY --from=builder /usr/app/expensemanagement.jar /usr/app/expensemanagement.jar

# Set the entry point
ENTRYPOINT ["/usr/lib/java-17-openjdk/bin/java", "-jar", "/usr/app/expensemanagement.jar"]